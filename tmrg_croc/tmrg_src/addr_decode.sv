...
// http://solderpad.org(org)/licenses/SHL-0.51(51). Unless required by applicable law
...
// Authors:
// - Wolfgang Roenninger <wroennin@ethz.ch(ch)>
// - Thomas Benz <tbenz@iis.ee(ee).ethz(ethz).ch(ch)>
