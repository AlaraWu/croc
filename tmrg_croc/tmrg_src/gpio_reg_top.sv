...
always_ff @(posedge clk_i or negedge rst_ni) begin
  ...
  // end
  assign bit_mask[7:0]   = {8{obi_req_i.a.be[0]}};
  assign bit_mask[15:8]  = {8{obi_req_i.a.be[1]}};
  assign bit_mask[23:16] = {8{obi_req_i.a.be[2]}};
  assign bit_mask[31:24] = {8{obi_req_i.a.be[3]}};
