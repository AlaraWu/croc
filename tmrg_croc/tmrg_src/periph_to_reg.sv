...
// tmrg tmr_error true
  ...
  logic [IW-1:0] r_id_d, r_id_q, r_id_qVoted;
  logic          r_opc_d, r_opc_q, r_opc_qVoted;
  logic          r_valid_d, r_valid_q, r_valid_qVoted;
  logic [DW-1:0] r_rdata_d, r_rdata_q, r_rdata_qVoted;
  assign r_id_qVoted    = r_id_q;
  assign r_opc_qVoted   = r_opc_q;
  assign r_valid_qVoted = r_valid_q;
  assign r_rdata_qVoted = r_rdata_q;
  ...
  assign r_rdata_o = r_rdata_qVoted;
  assign r_opc_o   = r_opc_qVoted;
  assign r_id_o    = r_id_qVoted;
  assign r_valid_o = r_valid_qVoted;
