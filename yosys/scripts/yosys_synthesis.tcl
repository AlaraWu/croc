...
yosys setattr -set keep_hierarchy 1 "t:croc_socTMR$*"
yosys setattr -set keep_hierarchy 1 "t:croc_domainTMR$*"
yosys setattr -set keep_hierarchy 1 "t:user_domainTMR$*"
yosys setattr -set keep_hierarchy 1 "t:core_wrapTMR$*"
yosys setattr -set keep_hierarchy 1 "t:cve2_register_file_ffTMR$*"
yosys setattr -set keep_hierarchy 1 "t:cve2_cs_registersTMR$*"
yosys setattr -set keep_hierarchy 1 "t:dmi_jtag$*"
yosys setattr -set keep_hierarchy 1 "t:dm_top$*"
yosys setattr -set keep_hierarchy 1 "t:gpioTMR$*"
yosys setattr -set keep_hierarchy 1 "t:timer_unitTMR$*"
yosys setattr -set keep_hierarchy 1 "t:reg_uart_wrapTMR$*"
yosys setattr -set keep_hierarchy 1 "t:soc_ctrl_reg_topTMR$*"
...
yosys setattr -set keep_hierarchy 1 "t:syncTMR$*"
