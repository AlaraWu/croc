...
set SRAM_2048x39_a     gen_2048x39xBx1.i_cut
set SRAM_2048x39_b     gen_2048x39xBx1.i_cut_0

# memory banks
set sram {\[0\].i_sram}
set bank0_sram0 $SRAM${sram}A/$SRAM_2048x32
set bank0_sram1 $SRAM${sram}B/$SRAM_2048x32
set bank0_sram2 $SRAM${sram}C/$SRAM_2048x32
set sram {\[1\].i_sram}
set bank1_sram0 $SRAM${sram}A/$SRAM_2048x32
