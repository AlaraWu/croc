...
placeInstance $bank0_sram1 $X [expr $Y - $RamSize1024x64_H - 15] R0
placeInstance $bank0_sram2 $X [expr $Y - 2*($RamSize1024x64_H + 15)] R0
placeInstance $bank1_sram0 $X2 $Y R0
placeInstance $bank1_sram1 $X2 [expr $Y - $RamSize1024x64_H - 15] R0
placeInstance $bank1_sram2 $X2 [expr $Y - 2*($RamSize1024x64_H + 15)] R0
